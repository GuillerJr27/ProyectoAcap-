                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="profile-bg-picture"
                                style="background-image:url('<?= base_url(); ?>assets/images/bg-profile.jpg')">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="profile-user-img"><img
                                                src="<?= base_url(); ?>assets/images/users/avatar-1.jpg" alt=""
                                                ...
                                                <div class="timeline-2">
                                                    <div class="time-item">
                                                        <div class="item-info ms-3 mb-3">
                                                            ...
                                                            <img src="<?= base_url(); ?>assets/images/small/small-3.jpg"
                                                                alt="" height="40" width="60" class="rounded-1">
                                                            <img src="<?= base_url(); ?>assets/images/small/small-4.jpg"
                                                                alt="" height="40" width="60" class="rounded-1">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="time-item">
                                                        <div class="item-info ms-3 mb-3">
                                                            ...
                                                            <img src="<?= base_url(); ?>assets/images/small/small-2.jpg"
                                                                alt="" height="40" width="60" class="rounded-1">
                                                            <img src="<?= base_url(); ?>assets/images/small/small-1.jpg"
                                                                alt="" height="40" width="60" class="rounded-1">
                                                        </div>
                                                    </div>
